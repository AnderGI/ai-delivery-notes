...
public final class ClientDetails {
	...
	public ClientDetails(String id, String name, String nid, String mail, String bankAccount, String bAddressName,
			String bPopulation, Integer bPostalCode, String bProvince, String dAddressName, String dPopulation,
			Integer dPostalCode, String dProvince) {
	...
	private ClientDetails(ClientId id, ClientName name, ClientNID nid, ClientMail mail,
			ClientDetailsBankAccount account, ClientDetailsBillingAddress bAddress,
	...
	// Create
	public static void create(EventBus bus, ClientDetailsRepository repo, String id, String name, String nid,
			String mail, String bankAccount, String bAddressName, String bPopulation, Integer bPostalCode,
			String bProvince, String dAddressName, String dPopulation, Integer dPostalCode, String dProvince)
			throws Exception {
		ClientDetails clientDetails = new ClientDetails(new ClientId(id), new ClientName(name), new ClientNID(nid),
				new ClientMail(mail), new ClientDetailsBankAccount(bankAccount),
	...
	public static void update(ClientDetailsRepository repo, EventBus bus, String idValue, String nameValue,
			...
			String deliveryProvinceValue) throws Exception {
		// Throws exception if found client is null
		ClientDetails c = ClientDetailsFinder.find(repo, idValue);
		ClientDetailsUpdater.update(repo, bus, idValue, nameValue, nidValue, mailValue, bankAccountValue,
				billingAddressNameValue, billingPopulationValue, billingPostalCodeValue, billingProvinceValue,
				deliveryAddressNameValue, deliveryPopulationValue, deliveryPostalCodeValue, deliveryProvinceValue, c);
	}
